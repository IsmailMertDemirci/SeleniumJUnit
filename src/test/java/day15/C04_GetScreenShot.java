...
public class C04_GetScreenShot extends TestBaseBeforeAfter {
    ...
    public void test1() throws IOException {
        ...
        //FileUtils.copyFile(pictureOfAllPage,new File("target/screenShot/"+driver.getTitle()+"AllPage.jpeg"));
        //FileUtils.copyFile(allImages,new File("target/ekranGoruntusu/"+faker.name().name()+"allPage.jpeg"));
        //aldigimiz ekran goruntusunu 25.satirdaki kod ile soldaki target menusu altina kaydettik
        //tarih ile duzenli bir sekilde kaydetmek icin LocalDateTime class'indan faydalanacagiz
