...
public class C05_ReadExcel {
    ...
    public void readExcelTest1() throws IOException {
        ...
        Assert.assertEquals(expectedSatirSayisi,sonSatirIndex+1);//indeksten dolayi +1

        int kullanilanSatirSayisi=workbook.getSheet("Sayfa2").getPhysicalNumberOfRows();
        int expectedKullanilanSatirSayisi=3;
        Assert.assertEquals(expectedKullanilanSatirSayisi,expectedKullanilanSatirSayisi);
    }
}
