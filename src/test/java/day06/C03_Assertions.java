...
public class C03_Assertions {
    ...
    //○ Sayfa URL’inin https://www.bestbuy.com/ ‘a esit oldugunu test edin
        ...
        //Assert.assertTrue(expectedUrl.contains(actualUrl)); diyebiliriz fakat esit olup olmadigini soruyor ondan equal
    }
    @Test
    public void test2(){
    //○ titleTest => Sayfa başlığının “Rest” içermediğini(contains) test edin
        ...
        //Assert.assertFalse(driver.getTitle().contains("Rest")); tek satirda yazabiliriz
    }
    @Test
    public void test3(){
    //○ logoTest => BestBuy logosunun görüntülendigini test edin
