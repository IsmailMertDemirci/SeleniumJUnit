...
public class P04 extends TestBaseBeforeAfter {
    @Test
    public void test1() {
        ...
        //locate kismina "//div[3]//img" da alabiliriz, locatin yaninda // ile altindaki emojilere gectik
        for (WebElement w:emojiler
             ) {
            w.click();
        }

        //lambda ile emojiler.forEach(WebElement::click);
        ...
        //Bu List'i kullanarak her bir web elementi kolayca boxes listinde bulunan web elementlerimize gonderebilecegiz
        List<String> text=new ArrayList<>
                (Arrays.asList("bu","list'i","kullanarak","her","bir","webelementi","kolayca","boxes","web","elementlerimize","gonderebilecegiz"));
